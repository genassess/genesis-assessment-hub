...
const translations = {
  en: {
    ...
    'hero.subtitle':
      'Empowering institutions with secure, high-quality examinations that maintain academic integrity and support educational excellence.',
    ...
    'about.subtitle':
      'Leading provider of secure educational assessments in South Sudan',
    'about.mission.title': 'Our Mission',
    'about.mission.text':
      'To provide educational institutions across South Sudan with reliable, secure, and professionally administered examination services that uphold the highest standards of academic integrity.',
    'about.values.title': 'Our Values',
    'about.values.integrity': 'Integrity',
    'about.values.integrity.text':
      'We maintain the highest standards of exam security and academic honesty.',
    'about.values.quality': 'Quality',
    'about.values.quality.text':
      'Every assessment is carefully crafted to meet educational standards.',
    'about.values.trust': 'Trust',
    'about.values.trust.text':
      'Schools rely on us to deliver consistent, professional examination services.',
    'about.team.title': 'Meet Our Team',
    'about.team.subtitle':
      'Dedicated professionals committed to educational excellence in South Sudan',
    'about.team.member1.name': 'Beasley Mboya',
    'about.team.member1.role': 'Chief Executive Officer',
    'about.team.member1.bio':
      'Over 5 years of teaching experience with over 2 years of examination panelist and examination supervision as both setter of examination and typist of examination.',
    'about.team.member2.name': 'Grace Achol Mayen',
    'about.team.member2.role': 'Director of Education',
    'about.team.member2.bio':
      'Curriculum development specialist with expertise in assessment design and educational standards.',
    'about.team.member3.name': 'Juma Harun',
    'about.team.member3.role': 'Operations Manager',
    'about.team.member3.bio':
      "Ensures seamless exam logistics and delivery across South Sudan's diverse regions.",
    'about.team.member4.name': 'Josephine Atieno',
    'about.team.member4.role': 'Quality Assurance Lead',
    'about.team.member4.bio':
      'Maintains examination standards and integrity through rigorous quality control processes.',

    // Services
    'services.title': 'Our Services',
    'services.subtitle':
      "Comprehensive examination solutions tailored to your institution's needs",
    'services.exam.title': 'Examination Development',
    'services.exam.text':
      'Custom-designed assessments aligned with curriculum standards and educational objectives.',
    'services.admin.title': 'Exam Administration',
    'services.admin.text':
      'Professional proctoring and logistics support to ensure fair and secure testing environments.',
    'services.security.title': 'Security & Integrity',
    'services.security.text':
      'Advanced security protocols to protect exam content and maintain the validity of results.',
    'services.support.title': 'Institutional Support',
    'services.support.text':
      'Dedicated guidance and consultation for schools throughout the examination process.',

    // Security Notice
    'security.title': 'Exam Material Security',
    'security.message':
      'To maintain the integrity and validity of our assessments, we do not provide downloadable exam papers, samples, or answer keys. This policy protects the educational value of our examinations and ensures fair testing for all students.',
    'security.cta':
      'Contact us for more information about our secure examination processes.',

    // Testimonials
    'testimonials.title': 'What Schools Say About Us',
    'testimonials.subtitle':
      'Trusted by educational institutions across South Sudan',
    ...
    'contact.subtitle':
      'Ready to bring secure, professional examinations to your institution?',
    ...
    'faq.a1':
      "You can place an order through our online Order Exams page or contact us directly. Fill out the form with your institution details, exam type, quantity, and preferred dates, and we'll guide you through the rest.",
    'faq.q2': 'What security measures protect exam materials?',
    'faq.a2':
      'We use secure distribution channels, controlled access systems, and strict protocols to prevent unauthorized access to exam content.',
    'faq.q3': 'Can I see sample questions before ordering?',
    'faq.a3':
      "We don't provide sample papers to maintain test security. However, we can discuss curriculum alignment and question formats during consultation.",
    'faq.q4': 'What languages are exams available in?',
    'faq.a4':
      'Our examinations are available in English and can be adapted for multilingual educational contexts.',
    'faq.q5': 'How far in advance should we order?',
    'faq.a5':
      'We recommend ordering at least 6-8 weeks before your planned examination date to ensure proper preparation and delivery.',
    'faq.q6': 'What happens after I submit an order?',
    'faq.a6':
      "After submission, you'll receive an email confirmation. Our team will review your order and contact you within 24-48 hours with a quote and to confirm details.",
    'faq.q7': 'What payment methods do you accept?',
    'faq.a7':
      'We accept bank transfers, mobile money, and institutional purchase orders. Payment details will be provided after order confirmation.',
    'faq.q8': 'Can I modify or cancel my order?',
    'faq.a8':
      'Yes, you can request modifications or cancellations by contacting us at least 2 weeks before the delivery date. Changes may affect pricing and timeline.',
    'faq.q9': 'Do you offer bulk discounts for large orders?',
    'faq.a9':
      "Yes, we offer discounted rates for bulk orders. Contact us with your requirements and we'll provide a customized quote.",
    'faq.q10': 'Can I contact you via WhatsApp for urgent inquiries?',
    'faq.a10':
      'Absolutely! For urgent matters or quick questions, you can reach us directly via WhatsApp through the link on our Order Exams page.',

    // Footer
    'footer.about':
      "Genesis Examinations is South Sudan's trusted provider of secure, professional educational assessment services.",
    ...
    'order.subtitle':
      'Request secure examination materials for your institution',
    ...
    'order.additionalNotes.placeholder':
    ...
    'order.success.message':
      'We have received your order and sent a confirmation to your email. Our team will contact you within 24-48 hours to confirm details and provide a quote.',
    ...
    'order.info.description':
      'Ordering examinations from Genesis is a straightforward process designed to ensure you receive secure, high-quality assessment materials on time.',
    ...
    'order.info.step4':
      'Receive secure exam materials before your delivery date',
    'order.whatsapp.title': 'Need Quick Assistance?',
    'order.whatsapp.description':
  ...
  ar: {
    ...
    'hero.subtitle':
      'تمكين المؤسسات من خلال امتحانات آمنة وعالية الجودة تحافظ على النزاهة الأكاديمية وتدعم التميز التعليمي.',
    ...
    'about.subtitle':
      'المزود الرائد للتقييمات التعليمية الآمنة في جنوب السودان',
    'about.mission.title': 'مهمتنا',
    'about.mission.text':
      'تزويد المؤسسات التعليمية في جميع أنحاء جنوب السودان بخدمات امتحانات موثوقة وآمنة ومُدارة باحترافية تلتزم بأعلى معايير النزاهة الأكاديمية.',
    'about.values.title': 'قيمنا',
    'about.values.integrity': 'النزاهة',
    'about.values.integrity.text':
      'نحافظ على أعلى معايير أمن الامتحانات والصدق الأكاديمي.',
    'about.values.quality': 'الجودة',
    'about.values.quality.text':
      'يتم إعداد كل تقييم بعناية لتلبية المعايير التعليمية.',
    'about.values.trust': 'الثقة',
    'about.values.trust.text':
      'تعتمد المدارس علينا لتقديم خدمات امتحانات متسقة واحترافية.',
    'about.team.title': 'تعرف على فريقنا',
    'about.team.subtitle':
      'محترفون متخصصون ملتزمون بالتميز التعليمي في جنوب السودان',
    'about.team.member1.name': 'جيمس أكوت دينق',
    'about.team.member1.role': 'الرئيس التنفيذي',
    'about.team.member1.bio':
      'أكثر من 20 عاماً من الخبرة في القيادة التعليمية، شغل سابقاً منصب مدير في وزارة التربية.',
    'about.team.member2.name': 'غريس أشول ماين',
    'about.team.member2.role': 'مديرة التعليم',
    'about.team.member2.bio':
      'متخصصة في تطوير المناهج مع خبرة في تصميم التقييمات والمعايير التعليمية.',
    'about.team.member3.name': 'بيتر قرنق بول',
    'about.team.member3.role': 'مدير العمليات',
    'about.team.member3.bio':
      'يضمن لوجستيات وتسليم الامتحانات بسلاسة عبر مناطق جنوب السودان المتنوعة.',
    'about.team.member4.name': 'سارة نيابول كور',
    'about.team.member4.role': 'رئيسة ضمان الجودة',
    'about.team.member4.bio':
      'تحافظ على معايير ونزاهة الامتحانات من خلال عمليات رقابة جودة صارمة.',
    ...
    'services.exam.text':
      'تقييمات مصممة خصيصاً ومتوافقة مع معايير المناهج والأهداف التعليمية.',
    'services.admin.title': 'إدارة الامتحانات',
    'services.admin.text':
      'مراقبة احترافية ودعم لوجستي لضمان بيئات اختبار عادلة وآمنة.',
    'services.security.title': 'الأمان والنزاهة',
    'services.security.text':
      'بروتوكولات أمان متقدمة لحماية محتوى الامتحانات والحفاظ على صحة النتائج.',
    'services.support.title': 'دعم المؤسسات',
    'services.support.text':
      'إرشاد واستشارات مخصصة للمدارس طوال عملية الامتحانات.',

    // Security Notice
    'security.title': 'أمان مواد الامتحانات',
    'security.message':
      'للحفاظ على نزاهة وصحة تقييماتنا، لا نوفر أوراق امتحانات أو نماذج أو مفاتيح إجابات قابلة للتحميل. هذه السياسة تحمي القيمة التعليمية لامتحاناتنا وتضمن اختباراً عادلاً لجميع الطلاب.',
    'security.cta':
      'اتصل بنا لمزيد من المعلومات حول عمليات الامتحانات الآمنة لدينا.',

    // Testimonials
    'testimonials.title': 'ماذا تقول المدارس عنا',
    'testimonials.subtitle':
      'موثوق من قبل المؤسسات التعليمية في جميع أنحاء جنوب السودان',
    ...
    'contact.subtitle':
      'هل أنت مستعد لإحضار امتحانات آمنة واحترافية إلى مؤسستك؟',
    ...
    'faq.a1':
      'يمكنك تقديم طلب من خلال صفحة طلب الامتحانات عبر الإنترنت أو الاتصال بنا مباشرة. املأ النموذج بتفاصيل مؤسستك ونوع الامتحان والكمية والتواريخ المفضلة، وسنرشدك خلال الباقي.',
    'faq.q2': 'ما هي الإجراءات الأمنية التي تحمي مواد الامتحانات؟',
    'faq.a2':
      'نستخدم قنوات توزيع آمنة وأنظمة وصول محكومة وبروتوكولات صارمة لمنع الوصول غير المصرح به لمحتوى الامتحانات.',
    'faq.q3': 'هل يمكنني رؤية نماذج أسئلة قبل الطلب؟',
    'faq.a3':
      'لا نقدم أوراق نماذج للحفاظ على أمن الاختبارات. ومع ذلك، يمكننا مناقشة توافق المناهج وأشكال الأسئلة أثناء الاستشارة.',
    'faq.q4': 'بأي لغات تتوفر الامتحانات؟',
    'faq.a4':
      'امتحاناتنا متوفرة باللغة الإنجليزية ويمكن تكييفها للسياقات التعليمية متعددة اللغات.',
    'faq.q5': 'كم من الوقت مقدماً يجب أن نطلب؟',
    'faq.a5':
      'نوصي بالطلب قبل 6-8 أسابيع على الأقل من تاريخ الامتحان المخطط له لضمان التحضير والتسليم المناسبين.',
    'faq.q6': 'ماذا يحدث بعد تقديم الطلب؟',
    'faq.a6':
      'بعد التقديم، ستتلقى تأكيداً بالبريد الإلكتروني. سيراجع فريقنا طلبك ويتصل بك خلال 24-48 ساعة مع عرض سعر وتأكيد التفاصيل.',
    'faq.q7': 'ما طرق الدفع التي تقبلونها؟',
    'faq.a7':
      'نقبل التحويلات البنكية والأموال عبر الهاتف المحمول وأوامر الشراء المؤسسية. سيتم تقديم تفاصيل الدفع بعد تأكيد الطلب.',
    'faq.q8': 'هل يمكنني تعديل أو إلغاء طلبي؟',
    'faq.a8':
      'نعم، يمكنك طلب تعديلات أو إلغاءات عن طريق الاتصال بنا قبل أسبوعين على الأقل من تاريخ التسليم. قد تؤثر التغييرات على الأسعار والجدول الزمني.',
    'faq.q9': 'هل تقدمون خصومات للطلبات الكبيرة؟',
    'faq.a9':
      'نعم، نقدم أسعاراً مخفضة للطلبات الكبيرة. اتصل بنا بمتطلباتك وسنقدم لك عرض سعر مخصص.',
    'faq.q10': 'هل يمكنني الاتصال بكم عبر واتساب للاستفسارات العاجلة؟',
    'faq.a10':
      'بالتأكيد! للأمور العاجلة أو الأسئلة السريعة، يمكنك الوصول إلينا مباشرة عبر واتساب من خلال الرابط في صفحة طلب الامتحانات.',

    // Footer
    'footer.about':
      'جينيسيس للامتحانات هي المزود الموثوق لخدمات التقييم التعليمي الآمنة والاحترافية في جنوب السودان.',
    ...
    'order.success.message':
      'لقد تلقينا طلبك وأرسلنا تأكيداً إلى بريدك الإلكتروني. سيتواصل معك فريقنا خلال 24-48 ساعة لتأكيد التفاصيل وتقديم عرض السعر.',
    'order.error.title': 'فشل الطلب',
    'order.error.submit':
      'فشل في تقديم الطلب. يرجى المحاولة مرة أخرى أو الاتصال بنا مباشرة.',
    ...
    'order.info.description':
      'طلب الامتحانات من جينيسيس عملية مباشرة مصممة لضمان حصولك على مواد تقييم آمنة وعالية الجودة في الوقت المحدد.',
    ...
    'order.whatsapp.description':
      'للاستفسارات العاجلة أو المساعدة الفورية، اتصل بنا مباشرة عبر واتساب.',
